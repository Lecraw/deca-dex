export const testimonials = [
  ...
  {
    text: "The judge simulator gave me confidence before competition. It predicted my actual score within 5 points. Absolutely game-changing!",
    image: "https://api.dicebear.com/9.x/avataaars/svg?seed=Alex",
    name: "Alex Thompson",
    role: "District Champion - IBP",
  },
  {
    text: "I went from zero business knowledge to winning at States. The research templates and AI guidance made complex topics understandable.",
  ...
  {
    text: "The roleplay practice feature is incredible. I practiced with AI judges and felt completely prepared for my presentation.",
  ...
  {
    text: "The AI-generated ideas were creative and unique. My project stood out from hundreds of others, and I made it to ICDC!",
    image: "https://api.dicebear.com/9.x/avataaars/svg?seed=Isabella",
    name: "Isabella Brown",
  ...
  {
    text: "The platform helped our team collaborate effectively. We could all work on different sections and see real-time progress.",
